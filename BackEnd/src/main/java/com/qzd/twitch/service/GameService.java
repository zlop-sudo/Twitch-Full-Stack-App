...
public class GameService {
    private static final String TOKEN = "Bearer ov30j3g4hmxdm6bgla9vyiouyxamy9";
    private static final String CLIENT_ID = "f4x3mzbqk8icuy9hefwk1c5js6kagf";
    ...
    private String searchTwitch(String url) throws TwitchException {
        ...
        // Define the response handler to parse and
        // return HTTP response body returned from Twitch
